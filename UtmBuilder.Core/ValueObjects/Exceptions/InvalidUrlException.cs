...
namespace UtmBuilder.Core.ValueObjects.Exceptions
{
    ...
    {
        private const string DefaultErroMessage = "Invalid URL";
        
        public InvalidUrlException(string message = DefaultErroMessage) : base(message)
        {

        } 

        public static void ThrowIfInvalid(string url, string message = DefaultErroMessage)
        {
